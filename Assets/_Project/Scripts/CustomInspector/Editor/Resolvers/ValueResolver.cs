...
namespace CustomInspector.Resolvers
{
    ...
    {
        public static ValueResolver<T> Resolve<T>(CustomPropertyDefinition propertyDefinition,
            string expression)
        {
        ...
        public static ValueResolver<string> ResolveString(CustomPropertyDefinition propertyDefinition,
            string expression)
        {
            if (expression != null && expression.StartsWith("$"))
            {
    ...
    public abstract class ValueResolver<T>
    {
        ...
        [PublicAPI]
        public abstract T GetValue(CustomProperty property, T defaultValue = default);
    }
