...
{
    public class CustomUnityInspectorUtilities
    {
        ...
        public static bool MustDrawWithUnity(CustomProperty property)
        {
        ...
        public static string GetStandardArrayElementName(CustomProperty property)
        {
        ...
        public static bool TryGetSpecialArrayElementName(CustomProperty property, out string name)
        {
