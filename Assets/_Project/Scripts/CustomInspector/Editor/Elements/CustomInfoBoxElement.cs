...
{
    public class CustomInfoBoxElement : CustomElement
    {
        ...
        public CustomInfoBoxElement(string message, CustomMessageType type = CustomMessageType.None, Color? color = null,
        ...
        {
            using (CustomGuiHelper.PushColor(_color))
            {
        ...
        private static Color GetColor(CustomMessageType type)
        {
            switch (type)
            {
        ...
        private static MessageType GetMessageType(CustomMessageType type)
        {
            switch (type)
            {
                case CustomMessageType.None: return MessageType.None;
                case CustomMessageType.Info: return MessageType.Info;
                case CustomMessageType.Warning: return MessageType.Warning;
                case CustomMessageType.Error: return MessageType.Error;
