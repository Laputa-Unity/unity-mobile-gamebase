...
{
    public class CustomBoxGroupElement : CustomHeaderGroupBaseElement
    {
        private readonly Props _props;

        private ValueResolver<string> _headerResolver;
        [CanBeNull] private CustomProperty _firstProperty;
        [CanBeNull] private CustomProperty _toggleProperty;
        ...
        public CustomBoxGroupElement(Props props = default) : base(new CustomHeaderGroupBaseElement.Props
        {
