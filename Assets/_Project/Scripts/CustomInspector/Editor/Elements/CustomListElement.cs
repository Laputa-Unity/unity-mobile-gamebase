...
{
    public class CustomListElement : CustomElement
    {
        ...
        public CustomListElement(CustomProperty property)
        {
        ...
        public override void OnGUI(Rect position)
        {
            ...
            using (CustomGuiHelper.PushLabelWidth(EditorGUIUtility.labelWidth - labelWidthExtra))
            {
        ...
        protected virtual CustomElement CreateItemElement(CustomProperty property)
        {
            return new CustomPropertyElement(property, new CustomPropertyElement.Props
            {
        ...
        private void DrawHeaderCallback(Rect rect)
        {
            ...
            {
                CustomEditorGUI.Foldout(labelRect, _property);
            }
        ...
        private void DrawElementCallback(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            using (CustomPropertyOverrideContext.BeginOverride(ListPropertyOverrideContext.Instance))
            {
        ...
        private static object CreateDefaultElementValue(CustomProperty property)
        {
        ...
        private static Array CloneValue(CustomProperty property)
        {
        ...
        private class ListPropertyOverrideContext : CustomPropertyOverrideContext
        {
