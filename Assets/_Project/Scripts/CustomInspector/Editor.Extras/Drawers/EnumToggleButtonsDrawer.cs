...
[assembly: RegisterCustomAttributeDrawer(typeof(EnumToggleButtonsDrawer), CustomDrawerOrder.Drawer,
    ApplyOnArrayElement = true)]

namespace CustomInspector.Drawers
{
    public class EnumToggleButtonsDrawer : CustomAttributeDrawer<EnumToggleButtonsAttribute>
    {
        ...
        private sealed class EnumToggleButtonsElement : CustomElement
        {
            private readonly CustomProperty _property;
            private readonly List<KeyValuePair<string, Enum>> _enumValues;
            private readonly bool _isFlags;

            public EnumToggleButtonsElement(CustomProperty property)
            {
                _property = property;
