...
[assembly: RegisterCustomAttributeValidator(typeof(AssetsOnlyValidator))]

namespace CustomInspector.Validators
{
    public class AssetsOnlyValidator : CustomAttributeValidator<AssetsOnlyAttribute>
    {
        ...
        public override CustomValidationResult Validate(CustomProperty property)
        {
            ...
            return CustomValidationResult.Error($"{obj} is not as asset.");
        }
    }
}