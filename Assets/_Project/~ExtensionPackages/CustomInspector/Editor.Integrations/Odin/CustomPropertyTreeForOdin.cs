...
{
    public sealed class CustomPropertyTreeForOdin<T> : CustomPropertyTree
    {
        private readonly IPropertyValueEntry<T> _odinValueEntry;
        private readonly InspectorProperty _odinProperty;
        private readonly SerializedProperty _serializedProperty;

        public CustomPropertyTreeForOdin(IPropertyValueEntry<T> odinValueEntry)
        {
            ...
            RootProperty = new CustomProperty(this, null, RootPropertyDefinition, -1, _serializedProperty);
