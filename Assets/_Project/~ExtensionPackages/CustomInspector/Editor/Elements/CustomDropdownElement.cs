...
{
    public class CustomDropdownElement : CustomElement
    {
        private readonly CustomProperty _property;
        private readonly Func<CustomProperty, IEnumerable<ICustomDropdownItem>> _valuesGetter;
        ...
        public CustomDropdownElement(CustomProperty property, Func<CustomProperty, IEnumerable<ICustomDropdownItem>> valuesGetter)
        {
            _property = property;
