...
{
    public sealed class CustomPropertyTreeForSerializedObject : CustomPropertyTree
    {
        private readonly SerializedObject _serializedObject;
        private readonly SerializedProperty _scriptProperty;

        public CustomPropertyTreeForSerializedObject([NotNull] SerializedObject serializedObject)
        {
            ...
            RootPropertyDefinition = new CustomPropertyDefinition(
                memberInfo: null,
                ownerType: null,
                order: -1,
                fieldName: "ROOT",
            ...
            RootProperty = new CustomProperty(this, null, RootPropertyDefinition, serializedObject);
        ...
        private void OnPropertyChanged(CustomProperty changedProperty)
        {
