...
namespace CustomInspector.Editor.Samples
{
    internal class CustomSamplesWindow : EditorWindow
    {
        ...
        private CustomPropertyTree _currentPropertyTree;
        ...
        private void DrawElement()
        {
            ...
            using (var scrollScope = new GUILayout.ScrollViewScope(_currentScroll))
            {
                ...
                using (new GUILayout.VerticalScope(SampleWindowStyles.Padding))
                {
                    ...
                    using (CustomGuiHelper.PushEditorTarget(_current))
        ...
        private void ChangeCurrentSample(Type type)
        {
            ...
            if (type != null)
            {
                ...
                _currentPropertyTree = new CustomPropertyTreeForSerializedObject(_currentSerializedObject);
            }
        }
        ...
        private class MenuTree : TreeView
        {
            ...
            protected override TreeViewItem BuildRoot()
            {
                ...
                var sampleTypes = typeof(CustomSamplesWindow).Assembly.GetTypes()
