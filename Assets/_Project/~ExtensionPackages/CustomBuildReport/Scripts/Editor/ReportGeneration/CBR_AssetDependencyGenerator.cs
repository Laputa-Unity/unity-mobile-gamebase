...
namespace CustomBuildReport
{
	...
	public static class AssetDependencyGenerator
	{
		...
		[MenuItem("Window/Utility/CBR - Check Dependencies of Scenes in Build (Direct)")]
		...
		[MenuItem("Window/Utility/CBR - Check Dependencies of Scenes in Build (Recursive)")]
		...
		public static void Create(AssetDependencies data, CustomBuildReport.BuildInfo.SceneInBuild[] scenes,
			bool debugLog = false)
		{
			var startingOpenSet = new Queue<string>();
		...
		public static void Create(AssetDependencies data, CustomBuildReport.BuildInfo buildInfo, bool createForUnusedAssetsToo,
			bool debugLog = false)
		{
			if (buildInfo == null)
			{
		...
		static void CalculateScriptDependencies(AssetDependencies data, CustomBuildReport.BuildInfo buildInfo)
		{
