...
namespace DldUtil
{
	public static class TraverseDirectory
	{
		...
		{
			//string folder = "C:/Users/Ferdi/Projects/_AssetStoreProducts/CustomBuildReport/BuildReportToolU353/BuildReportUnityProject/Assets/BuildReport/Scripts";
			string folder = Application.dataPath;

			Debug.Log("traverse at: " + folder);
			foreach (string file in Do(folder))
			{
				if (CustomBuildReport.Util.IsFileOfType(file, ".prefab"))
				{
