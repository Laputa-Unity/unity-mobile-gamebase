...
namespace CustomBuildReport.Window.Screen
{
	public class BuildStepsScreen : BaseScreen
	{
			...
			out bool requestRepaint)
		{
			...
			var buttonStyle = GUI.skin.FindStyle(CustomBuildReport.Window.Settings.TOP_BAR_BTN_STYLE_NAME);
			if (buttonStyle == null)
			{
			...
			var columnHeaderStyle = GUI.skin.FindStyle(CustomBuildReport.Window.Settings.LIST_COLUMN_HEADER_STYLE_NAME);
			...
			var listNormalStyle = GUI.skin.FindStyle(CustomBuildReport.Window.Settings.LIST_SMALL_STYLE_NAME);
			if (listNormalStyle == null)
			{
				listNormalStyle = GUI.skin.label;
			}

			var listAltStyle = GUI.skin.FindStyle(CustomBuildReport.Window.Settings.LIST_SMALL_ALT_STYLE_NAME);
			if (listAltStyle == null)
			{
				listAltStyle = GUI.skin.label;
			}

			var listSelectedStyle = GUI.skin.FindStyle(CustomBuildReport.Window.Settings.LIST_SMALL_SELECTED_NAME);
			...
			int messagePaginationLength = CustomBuildReport.Options.LogMessagePaginationLength;
		...
		void DrawMessages(BuildLogMessage[] messages, int messagesStartIdx, int messageLength, int stepIdx, int leftIndent, ref bool useAlt, ref bool requestRepaint)
		{
			...
			var listSelectedStyle = GUI.skin.FindStyle(CustomBuildReport.Window.Settings.LIST_NORMAL_SELECTED_NAME);
			if (listSelectedStyle == null)
			{
				listSelectedStyle = GUI.skin.label;
			}
