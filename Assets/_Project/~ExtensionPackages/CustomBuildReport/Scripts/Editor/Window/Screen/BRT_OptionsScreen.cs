...
namespace BuildReportTool.Window.Screen
{
	public class Options : BaseScreen
	{
		...
		)
		{
			...
			var usingCustom = BuildReportTool.Options.SearchType == SearchType.Custom;
			var caseSensitiveLabel = usingCustom ? "Case Sensitive Search (Not applicable to Custom Search. Custom Search is always Case Insensitive.)" : "Case Sensitive Search";
