...
namespace CustomBuildReport
{
	...
	/// </summary>
	[System.Serializable]
	public class UnityBuildReport : CustomBuildReport.IDataFile
	{
		/// <summary>
		...
		{
			return CustomBuildReport.Util.GetUnityBuildReportDefaultFilename(ProjectName, BuildType, TimeGot);
		}
	}
