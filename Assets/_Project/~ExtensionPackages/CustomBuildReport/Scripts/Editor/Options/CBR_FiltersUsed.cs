...
namespace CustomBuildReport
{
	public class FiltersUsed
	{
		...
		{
			return GetProperFileFilterGroupToUseFilePath(CustomBuildReport.Options.BuildReportSavePath);
		}
		...
		public static string GetProperFileFilterGroupToUseFilePath(string userFileFilterSavePath)
		{
			...
			string fileFilterGroupAtDefaultAssetsPath =
				CustomBuildReport.Options.BUILD_REPORT_TOOL_DEFAULT_PATH + "/" + FILE_FILTERS_USED_FILENAME;
...
/*
		string assetFolderPath = CustomBuildReport.Util.FindAssetFolder(Application.dataPath, CustomBuildReport.Config.BUILD_REPORT_TOOL_DEFAULT_FOLDER_NAME);
...
*/
			...
			string fileFilterGroupAtUserPersonalFolderDefaultName =
				CustomBuildReport.Util.GetUserHomeFolder() + "/" + CustomBuildReport.Options.BUILD_REPORTS_DEFAULT_FOLDER_NAME +
		...
		{
			return GetProperFileFilterGroupToUse(CustomBuildReport.Options.BuildReportSavePath);
		}
