...
public class CustomCSV
{
    ...
    public static string GetCSVRow(CustomRef r, params string[] suffixes)
    {
        var asset = r.asset;
        var sr = r.isSceneRef ? (CustomSceneRef) r : null;
        ...
        sb.Append(r.isSceneRef ? CustomSceneRef.FindUsageScene(new []{go}, false).Count : asset.UsageCount());
        sb.Append(SEPARATOR);
    ...
    public static string GetCSVRows(CustomRef[] source)
    {
        if (source == null)
        {
