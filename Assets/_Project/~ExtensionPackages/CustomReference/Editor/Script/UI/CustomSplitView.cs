...
namespace custom.find.reference
{
    ...
    public class CustomSplitView
    {
        ...
        public CustomSplitView(IWindow w)
        {
            this.window = w;
        }
        ...
        public class Info
        {
            ...
            public void DoDraw()
            {
                ...
                if (title != null)
                {
                    ...
                    GUI.Rect(titleRect, Color.black, 0.2f);

                    titleRect.xMin += 4f;
                    UnityEngine.GUI.Label(titleRect, title, EditorStyles.boldLabel);
                    drawRect.yMin += 16f;
                }
        ...
        void DrawSpliter(int index, float px)
        {
            ...
            {    
                GUI.Rect(dRect, Color.black, 0.4f);
            }
            
            var dRect2 = GUI.Padding(dRect, -2f, -2f);
