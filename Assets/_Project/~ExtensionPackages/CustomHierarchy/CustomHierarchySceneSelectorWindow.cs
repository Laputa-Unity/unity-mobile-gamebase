...
{
    public class CustomHierarchySceneSelectorWindow : EditorWindow
    {
        ...
        public static void Open(Vector2 rowPos, Scene sceneToReplace)
        {
            ...
            instance = ScriptableObject.CreateInstance<CustomHierarchySceneSelectorWindow>();
        ...
        public static CustomHierarchySceneSelectorWindow instance;
