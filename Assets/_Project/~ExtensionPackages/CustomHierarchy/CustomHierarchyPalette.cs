...
{
    public class CustomHierarchyPalette : ScriptableObject
    {
        ...
        public void Export()
        {
            var packagePath = EditorUtility.SaveFilePanel("Export CustomHierarchy Palette", "", this.GetPath().GetFilename(withExtension: false), "unitypackage");
