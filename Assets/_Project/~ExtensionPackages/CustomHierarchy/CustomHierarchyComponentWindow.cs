...
{
    public class CustomHierarchyComponentWindow : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            void header()
            {
                ...
                void icon()
                {
                    ...
                    GUI.Label(iconRect, CustomHierarchy.GetComponentIcon(component));
        ...
        void OnDestroy()
        {
            ...
            EditorPrefs.SetFloat("CustomHierarchy-componentWindowWidth", position.width);
        ...
        {
            floatingInstance = ScriptableObject.CreateInstance<CustomHierarchyComponentWindow>();
            ...
            var savedWidth = EditorPrefs.GetFloat("CustomHierarchy-componentWindowWidth", minWidth);
        ...
        public static CustomHierarchyComponentWindow floatingInstance;
