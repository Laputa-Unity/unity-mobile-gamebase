...
{
    [FilePath("Library/CustomHierarchy Cache.asset", FilePathAttribute.Location.ProjectFolder)]
    public class CustomHierarchyCache : ScriptableSingleton<CustomHierarchyCache>
    {
